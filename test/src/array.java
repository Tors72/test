...
public class array {
    static void at() { // used to store multiple values in single variable
        String[] fruits = new String[3]; //assigning max index value for an array. which is 3. (4 max string values)
    ...
    static void ar2d() { // array of arrays, multidimensional arrays
        ...
        String[][] colors = new String[2][2]; //THESE ARE NOT INDEX VALUES!!! (0,1)
    ...
    static void arob()
    {
        ...
        Food food2 = new Food("chezburger");

        Food[] refrigerants = {food1, food2};
        u.ps(refrigerants[0].name);
        u.ps(refrigerants[1].name);
    }
}
