...
public class arraytest {
    static void at() { // used to store multiple values in single variable
        ...
        fruits[0] = pu.msg("Enter the first fruit");
        fruits[1] = pu.msg("Enter the second fruit");
        fruits[2] = pu.msg("Enter the third fruit");
    ...
    static void ar2d() { // array of arrays, multidimensional arrays
        String[][] colors = new String[2][2]; //THESE ARE INDEX VALUES!!!
        ...
        pu.ps(String.valueOf((colors.length))); //[number of arrays
